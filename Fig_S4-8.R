...
cd_recount= plot_all("40_tcells/consensus_3/coloc_recount/coloc_result_CD.tsv.gz.Rdata")
ibd_recount= plot_all("40_tcells/consensus_3/coloc_recount/coloc_result_IBD.tsv.gz.Rdata")
uc_recount= plot_all("40_tcells/consensus_3/coloc_recount/coloc_result_UC.tsv.gz.Rdata")
