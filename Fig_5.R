...
my_plotter <- function(df){
  ...
  res = locuscompare(in_fn1=gwas_fn, in_fn2=eqtl_fn, title1="GWAS", title2="circQTL", marker_col1= marker_col, genome = "hg38", pval_col1=gwas_pvalue, marker_col2=marker_col, pval_col2=eqtl_pvalue)
  return(res)
}
#my_plotter(df)
...
pdf( file= "output_paper/Fig5.pdf",  width= 10, height= 10)
m
dev.off()
